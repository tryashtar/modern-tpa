...
data modify storage tpa:data temp.entry.name set from entity 6654354e-7c71-4608-b98e-a7986ad62697 text.insertion
kill 6654354e-7c71-4608-b98e-a7986ad62697

# failsafe, exit without changing anything if the name resolution didn't work (e.g. the summon failed)
execute unless data storage tpa:data temp.entry.name run return fail
