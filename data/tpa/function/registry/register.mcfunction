...
execute store result storage tpa:data entry.index int 1 run scoreboard players operation @s tpaindex = #index tpaindex
...
function tpa:registry/add with storage tpa:data entry
