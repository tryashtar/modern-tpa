...
data modify storage tpa:data temp.incoming_requests set value []
$data modify storage tpa:data temp.incoming_requests append from storage tpa:data persist.pending[{to:"$(name)"}]
